...
const DriverCardB = ({ num, fName, lName, team, number, driverImg, bgColor, flag }) => {
  return (
    <Link to={`/drivers/${num}`} className={`h-65 w-150 border-2 border-white rounded-xl ${bgColor} relative hover:scale-105 transition-all duration-300 group cursor-pointer block`}>
